  ...
  <div>
    ...
    <div>
      ...
      <v-col xs="6" md="11" class="mx-auto">
        <v-text-field :rules="[rules.required, rules.min]" v-model="pwdData.pwd" label="비밀번호" outlined id="pwd" type="password"></v-text-field>
      </v-col>
    </div>
    ...
    <div>
      ...
      <v-col xs="6" md="11" class="mx-auto">
        <v-text-field :rules="[rules.pwdcheck, rules.required]" v-model="pwdData.pwd2" label="비밀번호 확인" outlined id="pwd2" type="password"></v-text-field>
      </v-col>
    </div>
